...
public class MutiTankBulletAction implements Runnable {
	...
	public MutiTankBulletAction(int n, PublicResource pr, Tank tank,
			double angle, double v, double range) {
		this.pr = pr;
		...
		this.tank.setMutiTankBullet(n, angle);
